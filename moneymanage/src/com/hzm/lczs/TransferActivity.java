...
//		transfer_out_account_spn.setp
	...
	private void save(){
		...
		commondata.addTransfer(transfer,transfer_out_account_spn.getSelectedItem().toString());
		
		transfer.amount= transfer_amount;
		transfer.amount_id = transfer_in_account_spn.getSelectedItemPosition()+1;
		commondata.addTransfer(transfer,transfer_in_account_spn.getSelectedItem().toString());
