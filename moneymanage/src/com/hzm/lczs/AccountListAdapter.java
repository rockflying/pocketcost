...
public class AccountListAdapter extends BaseAdapter {
	...
	public AccountListAdapter(SettingAccountActivity activity,
			ArrayList<Object> accounts) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (item.getClass() == AccountData.class) {
			convertView = inflater.inflate(
					R.layout.simple_list_item_single_choice_for_account, null);
			AccountData data = (AccountData) item;

			String subcatname = commondata.accountsubcategory
			...
			((TextView) convertView.findViewById(R.id.account_name_tv))
					.setText(data.name);
			((TextView) convertView
					.findViewById(R.id.second_level_account_group_name_tv))
					.setText(subcatname);
			((TextView) convertView.findViewById(R.id.account_balance_tv))
					.setText(cost);

			convertView.setTag(data);
		} else {
			convertView = inflater.inflate(
					R.layout.widget_separated_listview_title_for_account, null);
